...
const ELEMENT_DATA: PeriodicElement[] = [
  ...
  { position: 2, name: 'abc', weight: 4.0026, symbol: 'He' },
  { position: 3, name: 'Lithium', weight: 6.941, symbol: 'Li' },
  { position: 4, name: 'abc', weight: 9.0122, symbol: 'Be' },
  { position: 5, name: '2', weight: 10.811, symbol: 'B' },
  { position: 6, name: 'Carbon', weight: 12.0107, symbol: 'C' },
  { position: 7, name: 'abc', weight: 14.0067, symbol: 'N' },
  { position: 8, name: 'Oxygen', weight: 15.9994, symbol: 'O' },
  { position: 9, name: 'abc', weight: 18.9984, symbol: 'F' },
